...
export const quizName = 'What Do You Know About This?';
...
export const quizDATA = [
	...
	},
	{
		...
		answers: [
			{
				id: 0,
				text: 'sliding to rollings',
				questionId: 2,
			},
			{
				id: 1,
				text: 'rolling to sliding',
				questionId: 2,
			},
			{
				id: 2,
	...
	{
		id: 3,
		text: 'For seeing objects at the surface of water from a submarine under water, the instrument used is',
		answers: [
			{
				id: 0,
				text: 'kaleidoscope',
