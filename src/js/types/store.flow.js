...
type TypeDispatchThunk = <R>(Action: TypeThunk<R>) => R // eslint-disable-line no-undef
type TypeDispatchAction = <R: TypeReduxAction | TypeAction>(action: R) => R // eslint-disable-line no-undef

export type TypeDispatch = TypeDispatchThunk & TypeDispatchAction

type TypeReduxAction = { type: string }
export type TypeThunk<R> = (dispatch: TypeDispatch, getState: TypeGetState) => R // eslint-disable-line no-undef
